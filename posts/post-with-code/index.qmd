...
For instance, if you collect data across dozens of scripts across a single program run there is no opportunity to commit everything at once.
...
Now you have a centralized solution which can be expanded to robustly log and handle all types of errors gracefully.